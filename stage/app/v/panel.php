...
<ul class="panel" >
  ...
  <li><label for="frunto_id" >单号</label><input type="text" name="frunto_id" id="frunto_id" autocomplete="off" value="<?=$_GET['action']?$_GET['frunto_id']:''?>"/></li>
...
<ul class="panel" >
 ...
 <li ><label for="ofrunto_id" >单号</label><input type="text" name="frunto_id" id="ofrunto_id"  value="<?=$_GET['action']==-1?$_GET['frunto_id']:''?>"/></li>
